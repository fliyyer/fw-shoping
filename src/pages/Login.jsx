    ...
    <div className="flex justify-center items-center h-screen overflow-hidden">
      ...
      <div className="w-1/2 bg-[#0e5b72] h-full flex flex-col justify-center px-40 my-auto">
        <form className="rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
          <h1 className="text-white font-bold text-[64px] text-center">
            Log In
          </h1>
          <p className="text-sm mt-5 font-bold text-white text-center">
            sign in to continue shopping
          </p>
          <div className="mb-4 mt-32">
            {errorMessage && (
              <div className="flex items-center justify-center text-red-500 text-sm mb-3">
                {errorMessage}
              </div>
            )}
          ...
          <div className="flex items-center justify-center">
            <button
              className="bg-white mx-auto text-black font-medium py-2 px-8 rounded-[10px] mt-10 focus:outline-none focus:shadow-outline"
              type="submit"
              style={{ boxShadow: '0px 8px 12px 0px rgba(0, 0, 0, 0.25)' }}>
              Sign In
            </button>
          </div>
          ...
          <div className="flex items-center justify-center w-full mt-10">
            ...
            <span className="mx-4 text-white text-nowrap italic">
              or continue with
            </span>
            <div className="w-full h-[1px] bg-white"></div>
          </div>
